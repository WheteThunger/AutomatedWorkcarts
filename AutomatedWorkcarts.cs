    ...
    internal class AutomatedWorkcarts : CovalencePlugin
    {
        ...
        protected override void LoadDefaultMessages()
        {
            ...
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ...
                [Lang.HelpOtherOptions] = "Outras opções: <color=#fd4>Condutor</color> | <color=#fd4>Freio</color> | <color=#fd4>Destruir</color> | <color=#fd4>@ROTA_NOME</color> | <color=#fd4>Habilitado</color> | <color=#fd4>Desabilitado</color>",
